...
async def create_group(
    ...
    try:
        ...
        response = await asyncio.to_thread(
            whatsapp_client.client.create_group,
            group_data
        )
...
async def get_group_participants(session_id: str, group_id: str) -> List[Participant]:
    ...
    try:
        ...
        response = await asyncio.to_thread(
            whatsapp_client.client.get_group_participants,
            request_data
        )
...
async def add_participant(
    ...
    try:
        ...
        response = await asyncio.to_thread(
            whatsapp_client.client.add_group_participant,
            request_data
        )
...
async def remove_participant(
    ...
    try:
        ...
        response = await asyncio.to_thread(
            whatsapp_client.client.remove_group_participant,
            request_data
        )
...
async def update_group_settings(
    ...
    try:
        ...
        response = await asyncio.to_thread(
            whatsapp_client.client.update_group_settings,
            request_data
        )
